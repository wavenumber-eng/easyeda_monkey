# EasyEDA Architecture Decision Records

ADRs for the EasyEDA parser package.

## Index

- [ADR-001](ADR-001-easyeda-native-data-model-and-api-conventions.md) - Native data model and API conventions
- [ADR-002](ADR-002-versioning-tagging-and-release-policy.md) - Versioning, tagging, and release policy
