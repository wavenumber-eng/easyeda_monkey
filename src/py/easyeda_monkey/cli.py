"""Command-line entry points for EasyEDA Monkey."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    fetch_parser = subparsers.add_parser(
        "fetch-part",
        help=_command_help("fetch-part"),
        description="Fetch an EasyEDA / LCSC component by C-number.",
    )
    fetch_parser.add_argument("lcsc_id", help="LCSC part number, such as C21190 or 21190.")
    ...
    fetch_parser.set_defaults(handler=_run_fetch_part)
    return parser
...
def _run_fetch_part(args: argparse.Namespace) -> int:
...
def _command_help(name: str) -> str:
    """Return help text for a registered command."""
